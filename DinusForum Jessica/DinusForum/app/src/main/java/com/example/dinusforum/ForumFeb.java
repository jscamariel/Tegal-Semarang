...
public class ForumFeb extends AppCompatActivity {
    private final static  String STATUS = "Data Thread";
    RecyclerView recycler_feb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_feb);

        recycler_feb = findViewById(R.id.recycler_feb);

        recycler_feb.setHasFixedSize(true);
        ...
        recycler_feb.setLayoutManager(layoutManager);
        adapter = new RecyclerAdapterFeb(getApplicationContext(),arrayList);
        recycler_feb.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_FEB_URL)
                .setTag("test")
