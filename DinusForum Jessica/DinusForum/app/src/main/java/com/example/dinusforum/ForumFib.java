...
public class ForumFib extends AppCompatActivity {
    private final static  String STATUS = "Data Thread";
    RecyclerView recycler_fib;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_fib);

        recycler_fib = findViewById(R.id.recycler_fib);

        recycler_fib.setHasFixedSize(true);
        ...
        recycler_fib.setLayoutManager(layoutManager);
        adapter = new RecyclerAdapterFib(getApplicationContext(),arrayList);
        recycler_fib.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_FIB_URL)
                .setTag("test")
