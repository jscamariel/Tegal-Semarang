...
public class ForumFik extends AppCompatActivity {
    private final static  String STATUS = "Data Thread";
    RecyclerView recycler_fik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_fik);

        recycler_fik = findViewById(R.id.recycler_fik);

        recycler_fik.setHasFixedSize(true);
        ...
        recycler_fik.setLayoutManager(layoutManager);
        adapter = new RecyclerAdapterFik(getApplicationContext(),arrayList);
        recycler_fik.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_FIK_URL)
                .setTag("test")
