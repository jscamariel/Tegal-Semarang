...
public class ForumFkes extends AppCompatActivity {
    private final static  String STATUS = "Data Thread";
    RecyclerView recycler_fkes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_fkes);

        recycler_fkes = findViewById(R.id.recycler_fkes);

        recycler_fkes.setHasFixedSize(true);
        ...
        recycler_fkes.setLayoutManager(layoutManager);
        adapter = new RecyclerAdapterFkes(getApplicationContext(),arrayList);
        recycler_fkes.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_FKES_URL)
                .setTag("test")
