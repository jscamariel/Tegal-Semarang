...
public class ForumGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_game);

        recycler_game = findViewById(R.id.recycler_game);

        recycler_game.setHasFixedSize(true);
        ...
        adapter = new RecyclerAdapterGame(getApplicationContext(),arrayList);
        recycler_game.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_GAME_URL)
                .setTag("test")
