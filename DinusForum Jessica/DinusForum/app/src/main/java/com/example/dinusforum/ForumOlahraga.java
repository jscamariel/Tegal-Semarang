...
public class ForumOlahraga extends AppCompatActivity {
    private final static  String STATUS = "Data Thread";
    RecyclerView recycler_olahraga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_olahraga);

        recycler_olahraga = findViewById(R.id.recycler_olahraga);

        recycler_olahraga.setHasFixedSize(true);
        ...
        recycler_olahraga.setLayoutManager(layoutManager);
        adapter = new RecyclerAdapterOlahraga(getApplicationContext(),arrayList);
        recycler_olahraga.setAdapter(adapter);

    }
    public void readDataFromServer(){
        AndroidNetworking.get(DbContract.SERVER_GET_OLAHRAGA_URL)
                .setTag("test")
