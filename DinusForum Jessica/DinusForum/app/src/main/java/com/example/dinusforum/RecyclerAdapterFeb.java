...
public class RecyclerAdapterFeb extends RecyclerView.Adapter<RecyclerAdapterFeb.MyViewHolder> {
    private Context context;
    private ArrayList<Data> arrayList ;
    //private Activity activity;
    public RecyclerAdapterFeb(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterFeb.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_feb, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterFeb.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_FEB_URL)
