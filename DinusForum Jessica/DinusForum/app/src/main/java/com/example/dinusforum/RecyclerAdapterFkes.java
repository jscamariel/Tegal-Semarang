...
public class RecyclerAdapterFkes extends RecyclerView.Adapter<RecyclerAdapterFkes.MyViewHolder> {
    private Context context;
    private ArrayList<Data> arrayList ;
    //private Activity activity;
    public RecyclerAdapterFkes(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterFkes.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_fkes, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterFkes.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_FKES_URL)
