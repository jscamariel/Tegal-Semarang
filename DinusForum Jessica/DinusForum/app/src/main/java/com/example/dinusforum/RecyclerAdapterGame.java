...
public class RecyclerAdapterGame extends RecyclerView.Adapter<RecyclerAdapterGame.MyViewHolder> {
    ...
    public RecyclerAdapterGame(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterGame.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_game, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterGame.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_GAME_URL)
