...
public class RecyclerAdapterOlahraga extends RecyclerView.Adapter<RecyclerAdapterOlahraga.MyViewHolder> {
    private Context context;
    private ArrayList<Data> arrayList ;
    //private Activity activity;
    public RecyclerAdapterOlahraga(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterOlahraga.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_olahraga, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterOlahraga.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_OLAHRAGA_URL)
