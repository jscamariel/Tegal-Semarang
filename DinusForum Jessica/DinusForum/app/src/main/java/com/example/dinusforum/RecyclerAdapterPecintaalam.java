...
public class RecyclerAdapterPecintaalam extends RecyclerView.Adapter<RecyclerAdapterPecintaalam.MyViewHolder> {
    private Context context;
    private ArrayList<Data> arrayList ;
    //private Activity activity;
    public RecyclerAdapterPecintaalam(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterPecintaalam.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_pecintaalam, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterPecintaalam.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_PECINTAALAM_URL)
