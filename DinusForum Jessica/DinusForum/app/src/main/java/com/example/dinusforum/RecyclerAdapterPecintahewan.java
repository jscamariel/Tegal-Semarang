...
public class RecyclerAdapterPecintahewan extends RecyclerView.Adapter<RecyclerAdapterPecintahewan.MyViewHolder> {
    private Context context;
    private ArrayList<Data> arrayList ;
    //private Activity activity;
    public RecyclerAdapterPecintahewan(Context context, ArrayList<Data> arrayList){
    ...
    @Override
    public RecyclerAdapterPecintahewan.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layout_row_pecintahewan, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterPecintahewan.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void hapusData(){
            AndroidNetworking.delete(DbContract.SERVER_GET_PECINTAHEWAN_URL)
