...
class Fib extends REST_Controller
{
    ...
    public function fib_get()
    {       
        $id_thread = $this->get('id_thread');
        if($id_thread===null){
            $fib = $this->Fib_model->getAllFib();
        }else{
            $fib = $this->Fib_model->getAllFib($id_thread);
        }
    ...
    public function fib_delete(){
        ...
        if($id_thread===null){
            ...
            if($this->Fib_model->deleteFib($id_thread) > 0){
                $this->response([
                    'status' => true,
                    'id_thread' => $id_thread,
    ...
    public function fib_post(){
        ...
        if($this->Fib_model->createFib($data) > 0){
            $this->response([
                'status' => true,
    ...
    public function fib_put(){
        ...
        if($this->Fib_model->updateFib($data,$id_thread) > 0){
            $this->response([
                'status' => true,
