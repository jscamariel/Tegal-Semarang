...
class Fkes extends REST_Controller
{
    ...
    public function fkes_get()
    {       
        $id_thread = $this->get('id_thread');
        if($id_thread===null){
            $fkes = $this->Fkes_model->getAllFkes();
        }else{
            $fkes = $this->Fkes_model->getAllFkes($id_thread);
        }
    ...
    public function fkes_delete(){
        ...
        if($id_thread===null){
            ...
            if($this->Fkes_model->deleteFkes($id_thread) > 0){
                $this->response([
                    'status' => true,
                    'id_thread' => $id_thread,
    ...
    public function fkes_post(){
        ...
        if($this->Fkes_model->createFkes($data) > 0){
            $this->response([
                'status' => true,
    ...
    public function fkes_put(){
        ...
        if($this->Fkes_model->updateFkes($data,$id_thread) > 0){
            $this->response([
                'status' => true,
