...
class Otomotif extends REST_Controller
{
    ...
    public function otomotif_get()
    {       
        $id_thread = $this->get('id_thread');
        if($id_thread===null){
            $otomotif = $this->Otomotif_model->getAllOtomotif();
        }else{
            $otomotif = $this->Otomotif_model->getAllOtomotif($id_thread);
        }
    ...
    public function otomotif_delete(){
        ...
        if($id_thread===null){
            ...
            if($this->Otomotif_model->deleteOtomotif($id_thread) > 0){
                $this->response([
                    'status' => true,
                    'id_thread' => $id_thread,
    ...
    public function otomotif_post(){
        ...
        if($this->Otomotif_model->createOtomotif($data) > 0){
            $this->response([
                'status' => true,
    ...
    public function otomotif_put(){
        ...
        if($this->Otomotif_model->updateOtomotif($data,$id_thread) > 0){
            $this->response([
                'status' => true,
