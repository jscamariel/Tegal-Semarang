            ...
            <?php foreach ($admin as $ad) : ?>
                <tbody>
                    <tr>
                        ...
                        <td><?= $ad['timestamp']; ?></td>
                        <td>
                            <a href="<?= base_url(); ?>admin/admin/hapusFib/<?= $ad['id_thread']; ?>" class="icofont-trash btn btn-danger" onclick="return confirm('Yakin?');" title="Hapus"></a>
                            <a href="<?= base_url(); ?>admin/admin/detailFib/<?= $ad['id_thread']; ?>" class="icofont-trash btn btn-warning icofont-info-circle" title="Detail"></a>
                        </td>
                    </tr>
                </tbody>
            <?php endforeach; ?>
