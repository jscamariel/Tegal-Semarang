            ...
            <?php foreach ($admin as $ad) : ?>
                <tbody>
                    <tr>
                        ...
                        <td><?= $ad['username']; ?></td>
                        <td><a href="<?= base_url(); ?>fkes/detail/<?= $ad['id_thread']; ?>"><?= $ad['nama_thread']; ?></a></td>
                        <td><?= $ad['isi']; ?></td>
                        <td><?= $ad['timestamp']; ?></td>
                        <td><a href="<?= base_url(); ?>admin/admin/hapusFkes/<?= $ad['id_thread']; ?>" class="badge badge-danger" onclick="return confirm('Yakin?');">Hapus</a></td>
                    </tr>
                </tbody>
            <?php endforeach; ?>
        </table>
