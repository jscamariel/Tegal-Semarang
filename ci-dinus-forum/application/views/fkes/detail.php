<div class="container-content">
    <row class="mt-3">
        <div class="col-md-6">
            ...
            <form method="POST" action="<?= base_url('fkes/kirimKomen/') . $fkes['id_thread']; ?>">
            ...
            <div class="card mt-1">
                <div class="card-body">
                    ...
                    <?php foreach ($komentar as $komen) : ?>
                        ...
                        <?php else : ?>
                            <?php if ($komen['id_thread'] == $fkes['id_thread']) : ?>
                                ...
                                <?php else : ?>
                                    <a href="<?= base_url(); ?>fkes/hapusKomen/<?= $komen['id_komentar']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin?');">Hapus</a>

                                    <a href="<?= base_url(); ?>fkes/ubah/<?= $komen['id_komentar']; ?>" class="badge badge-warning float-right">Ubah</a>
                                <?php endif; ?>
            ...
            <a href="<?= base_url(); ?>fkes" class="btn btn-primary mt-5">Kembali</a>
