...
<div class="bg-light " id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="<?= base_url(); ?>fik" class="list-group-item list-group-item-action bg-light icofont-computer">Teknik Informatika</a>
    <a href="<?= base_url(); ?>feb" class="list-group-item list-group-item-action bg-light icofont-money">Ekonomi dan Bisnis</a>
    <a href="<?= base_url(); ?>fib" class="list-group-item list-group-item-action bg-light icofont-male">Ilmu Budaya</a>
    <a href="<?= base_url(); ?>fkes" class="list-group-item list-group-item-action bg-light icofont-medicine">Kesehatan</a>
