...
<div class="bg-light " id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    <a href="#" class="list-group-item list-group-item-action bg-light icofont-network-tower">Teknik Elektro</a>
    <a href="#" class="list-group-item list-group-item-action bg-light icofont-computer">Teknik Informatika</a>
    <a href="#" class="list-group-item list-group-item-action bg-light icofont-money">Ekonomi dan Bisnis</a>
    <a href="#" class="list-group-item list-group-item-action bg-light icofont-male">Ilmu Budaya</a>
    <a href="#" class="list-group-item list-group-item-action bg-light icofont-medicine">Kesehatan</a>
